...
<template>
  <header>
    <nav
      class="navbar btn"
      style="border-color: rgb(37, 133, 58); border-width: 2px"
    >
      <div class="container">
        <img
          class="logo"
          src="src/assets/images/Captura_de_tela_de_2022-06-11_08-50-51.png"
          alt=""
          width="180"
          height="60"
        />
        <div class="botao1">
          <button id="botao" class="btn btn">
  ...
  <main>
    ...
    <div class="dogslinks">
      <div>
        <router-link style="text-decoration: none; margin: 1% 10%" to="/about"
          >fumaça</router-link
        >
        <router-link style="text-decoration: none; margin: 1% 10%" to="/about"
          >maicon</router-link
      ...
      <div class="ifc">
        ...
        <button
          ...
          style="
            ...
            border-color: rgb(37, 133, 58);
          "
        >
          <a href="https://araquari.ifc.edu.br">conheca o ifc</a>
        </button>
      </div>
    </div>
  </main>
    ...
    <ul class="nav col-md-4 list-unstyled d-flex">
      <li class="ms-3">
        <a class="text-muted" href="#"
          >(047) 99999-9999<svg class="bi" width="24" height="24">
            <use xlink:href="#twitter">oi</use>
          </svg></a
        >
      </li>
      <li class="ms-3">
        <a class="text-muted" href="#"
          >hakctouille<svg class="bi" width="24" height="24">
            <use xlink:href="#instagram"></use></svg
        ></a>
      </li>
      <li class="ms-3">
        <a class="text-muted" href="#"
          >@hacktouille<svg class="bi" width="24" height="24">
